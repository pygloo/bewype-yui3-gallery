    ...
    Y.extend( PickerFile, Y.Widget, {
        ...
        _doUpload : function () {
	    	...
	    	var _handleSuccess = function(ioId, o){
			    Y.log( 'File upload succeed: ' + ioId, 'debug', 'yui3-picker-file' );
                this._fileName = null;
            };
 
    		//A function handler to use for failed requests:
	    	var _handleFailure = function(ioId, o){
		    	    Y.log( 'File upload failed: ' + ioId, 'debug', 'yui3-picker-file' );
    		};
            ...
            Y.log('Initiating request: ' + request.id, 'debug', 'yui3-picker-file' );
    	},
